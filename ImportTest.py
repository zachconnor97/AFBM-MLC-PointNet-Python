...
class ImportTest:
    def __init__(self, num_points= 3000, batch_size= 32, num_classes= 25, username='Zachariah' ) -> None:
        self.seed = tf.random.set_seed(1234)
    ...
    def pc_read(self, path):
        ...
        # cloud_path_header = str('/mnt/c/Users/' + self.username +'/OneDrive - Oregon State University/Research/AFBM/AFBM Code/AllClouds10k/AllClouds10k/')
