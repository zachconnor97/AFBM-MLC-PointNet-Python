...
def generate_dataset(filename):
    ...
    val_ds = tf.data.Dataset.zip((file_id, val_points, val_label))
    train_ds = tf.data.Dataset.zip((file_id, train_points, train_label))
...
def generator_dataset(filename):
